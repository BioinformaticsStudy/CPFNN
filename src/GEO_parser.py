...
# geoID = 'GSE40279' # sample size: 656

# gse = GEOparse.get_GEO(geo=geoID, destdir="./")
# if the file had already existed on the disk: 
#gse = GEOparse.get_GEO(filepath="./GSE95049_family.soft.gz")

# age_str as 'characteristics_ch1.1.age' is the age string, which varies in every dataset. 
# can be found by gse.phenotype_data.columns 
# so can the disease string
#age_str = 'characteristics_ch1.5.age'
#disease_str = 'source_name_ch1'
#disease_keyword = 'BLOOD'

# full dict
geo_dict = {
 	'GSE67530': ['characteristics_ch1.1.age', 'characteristics_ch1.3.ards', 'NA', '0', '0'],
 	'GSE50660': ['characteristics_ch1.1.age', '0', '0', '0', '0'],
 	'GSE61151': ['characteristics_ch1.12.agebloodtaken', '0', '0', '0', '0'], 
 	'GSE87650': ['characteristics_ch1.0.age', 'characteristics_ch1.2.disease state (diagnosisfull)', 'HL (Healthy control (Lab volunteer))', 'characteristics_ch1.0.cell type', 'Whole blood'], 
 	'GSE52113': ['characteristics_ch1.2.age', '0', '0', '0', '0'],
 	'GSE53128': ['characteristics_ch1.3.age', '0', '0', '0', '0'],
 	'GSE51388': ['characteristics_ch1.0.age', '0', '0', '0', '0'], 
 	'GSE36064': ['characteristics_ch1.5.age at collection months', '0', '0', '0', '0'],
 	'GSE41169': ['characteristics_ch1.6.age', 'characteristics_ch1.7.diseasestatus (1=control, 2=scz patient)', '1', '0', '0'],
 	'GSE40279': ['characteristics_ch1.0.age (y)', '0', '0', '0', '0'], 
 	'GSE60132': ['characteristics_ch1.1.age', '0','0','0','0'], 
 	'GSE52588': ['characteristics_ch1.4.age', 'characteristics_ch1.1.disease state', 'healthy', '0', '0'], 
 	'GSE69270': ['characteristics_ch1.0.age in 2011', '0', '0', '0', '0'], 
 	'GSE67705': ['characteristics_ch1.1.age', 'characteristics_ch1.0.subject status/id', 'NaN', 'characteristics_ch1.2.tissue', 'whole blood'], 
 	'GSE77445': ['characteristics_ch1.2.age', '0', '0', '0', '0'], 
 	'GSE65638': ['characteristics_ch1.1.age', '0', '0', '0', '0'], 
 	'GSE73103': ['characteristics_ch1.2.age', '0', '0', '0', '0'], 
 	'GSE67751': ['characteristics_ch1.1.age', 'characteristics_ch1.2.hivstatus', 'Negative', '0', '0'], 
 	'GSE64495': ['characteristics_ch1.2.age', 'characteristics_ch1.7.disease status', 'Control', '0', '0'], 
 	'GSE59509': ['characteristics_ch1.0.age (years)', '0', '0', 'characteristics_ch1.3.tissue', 'whole blood'], 
 	'GSE62003': ['characteristics_ch1.2.age', '0', '0', '0', '0'],
 	'GSE106648':['characteristics_ch1.2.age', 'characteristics_ch1.0.disease status', 'Healthy control', '0', '0']
}

# test dict with several small datasets
geo_dict_few = {
    'GSE65638': ['characteristics_ch1.1.age', '0', '0', '0', '0'], # 16
	'GSE52588': ['characteristics_ch1.4.age', 'characteristics_ch1.1.disease state', 'healthy', '0', '0'] # 58
}
# test dict with 1000+ samples
geo_dict_1k = {
    # 'GSE67530': ['characteristics_ch1.1.age', 'characteristics_ch1.3.ards', 'NA', '0', '0'],
    'GSE50660': ['characteristics_ch1.1.age', '0', '0', '0', '0'],   # sample size: 464
    # 'GSE61151': ['characteristics_ch1.12.agebloodtaken', '0', '0', '0', '0'], 
    'GSE87650': ['characteristics_ch1.0.age', 'characteristics_ch1.2.disease state (diagnosisfull)', 'HL (Healthy control (Lab volunteer))', 'characteristics_ch1.0.cell type', 'Whole blood'], # sample size: 191
    # 'GSE52113': ['characteristics_ch1.2.age', '0', '0', '0', '0'],
    # 'GSE53128': ['characteristics_ch1.3.age', '0', '0', '0', '0'],
    # 'GSE51388': ['characteristics_ch1.0.age', '0', '0', '0', '0'], 
    # 'GSE36064': ['characteristics_ch1.5.age at collection months', '0', '0', '0', '0'],
    # 'GSE41169': ['characteristics_ch1.6.age', 'characteristics_ch1.7.diseasestatus (1=control, 2=scz patient)', '1', '0', '0'],
    'GSE40279': ['characteristics_ch1.0.age (y)', '0', '0', '0', '0'],  # sample size: 656
    # 'GSE60132': ['characteristics_ch1.1.age', '0','0','0','0'], 
    # 'GSE52588': ['characteristics_ch1.4.age', 'characteristics_ch1.1.disease state', 'healthy', '0', '0'], 
    # 'GSE69270': ['characteristics_ch1.0.age in 2011', '0', '0', '0', '0'], 
    # 'GSE67705': ['characteristics_ch1.1.age', 'characteristics_ch1.0.subject status/id', 'NaN', 'characteristics_ch1.2.tissue', 'whole blood'], 
